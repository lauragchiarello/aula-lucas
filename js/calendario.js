...
var Calendario = (function () {
  ...
  function diasComAgendamento(ano, mes) {
    var dias = {};
    Storage.getAgendamentos().forEach(function (a) {
  ...
  function celulaDia(dia, ehHoje, temEvento, ano, mes) {
    ...
    btn.setAttribute("aria-label", dia + " de " + new Date(ano, mes, dia).toLocaleDateString("pt-BR", { month: "long" }));
  ...
  function renderizar() {
    ...
    var marcacoes = diasComAgendamento(anoCal, mesCal);
